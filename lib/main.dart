...
part 'investment_13f_sector.dart';
...
part 'investment_rule_analysis.dart';
...
const _uiChinese = <String, String>{
  ...
  'Luxury Goods': '奢侈品',
  'Marine Shipping': '海运',
  'Medical Care Facilities': '医疗服务设施',
  'Medical Devices': '医疗器械',
  'Medical Distribution': '医疗产品分销',
  'Medical Instruments & Supplies': '医疗仪器与耗材',
  'Metal Fabrication': '金属加工',
  'Mortgage Finance': '抵押贷款融资',
  ...
  'Pollution & Treatment Controls': '污染防治设备',
  'Publishing': '出版',
  'REIT - Diversified': '综合房地产信托',
  'REIT - Healthcare Facilities': '医疗房地产信托',
  'REIT - Hotel & Motel': '酒店房地产信托',
  'REIT - Industrial': '工业房地产信托',
  'REIT - Mortgage': '抵押贷款房地产信托',
  'REIT - Office': '办公房地产信托',
  'REIT - Residential': '住宅房地产信托',
  'REIT - Retail': '零售房地产信托',
  'REIT - Specialty': '专业房地产信托',
  'Railroads': '铁路',
  ...
  'Restaurants': '餐饮',
  'Savings & Cooperative Banks': '储蓄与合作银行',
